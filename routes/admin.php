...
Route::middleware('admin')->group(function () {
    ...
    // Forum
    Route::controller('ForumController')->prefix('forum')->name('forum.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('store/{id?}', 'store')->name('store');
        Route::post('status/{id}', 'status')->name('status');
    });
    // topic
    Route::controller('ManageTopicController')->prefix('topic')->name('topic.')->group(function () {
        ...
        Route::post('comment/delete/{id}/{topicId}', 'commentDelete')->name('comment.delete');
    });
    // Category
