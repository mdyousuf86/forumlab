...
trait SupportTicketManager {
    ...
    public function storeSupportTicket(Request $request) {
        ...
        $request->merge(['ticket_open' => 0, 'ticket_reply' => 1]);
        ...
        $ticket->name       = $request->name ?? $user->fullname;
        $ticket->email      = $request->email ?? $user->email;
    ...
    protected function validation($request) {
        ...
        $request->validate([
            ...
            'name'        => 'required_without_all:ticket_reply, ticket_open',
            'email'       => 'required_without_all:ticket_reply, ticket_open|email|max:255',
