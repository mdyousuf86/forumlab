                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Topic Auto Approval')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the system will automatic approve topic So be sure before disabling this module that, the system doesn\'t send any SMS or Email to users.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="auto_approval" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if ($general->auto_approval) checked @endif>
                                </div>
                            </li>
