    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.forum.index') }}">
                    <a class="nav-link" href="{{ route('admin.forum.index') }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.topic*', 3) }}" href="javascript:void(0)">
                        <i class="menu-icon las la-list-ul"></i>
                        <span class="menu-title">@lang('Manage Topic')</span>
                        @if ($pendingTopic > 0)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.topic*', 2) }}">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.topic.list') }}">
                                <a class="nav-link" href="{{ route('admin.topic.list') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Topics')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.topic.pending') }}">
                                <a class="nav-link" href="{{ route('admin.topic.pending') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Topics')</span>
                                    @if ($pendingTopic)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pendingTopic }}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.topic.approved') }}">
                                <a class="nav-link" href="{{ route('admin.topic.approved') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Topics')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.topic.trashed') }}">
                                <a class="nav-link" href="{{ route('admin.topic.trashed') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Trashed Topics')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.topic.rejected') }}">
                                <a class="nav-link" href="{{ route('admin.topic.rejected') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Topics')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
